...
abstract class ImplicitlyAnimatedGridBase<W extends Widget, E extends Object>
  ...
  const ImplicitlyAnimatedGridBase({
    Key? key,
    required this.items,
...
abstract class ImplicitlyAnimatedGridBaseState<W extends Widget,
        B extends ImplicitlyAnimatedGridBase<W, E>, E extends Object>
    extends State<B> with DiffCallback<E>, TickerProviderStateMixin {
  @protected
  GlobalKey<CustomSliverAnimatedGridState> animatedListKey = GlobalKey();

  @nonVirtual
  @protected
  CustomSliverAnimatedGridState get list => animatedListKey.currentState!;
  ...
  @override
  void didUpdateWidget(ImplicitlyAnimatedGridBase oldWidget) {
