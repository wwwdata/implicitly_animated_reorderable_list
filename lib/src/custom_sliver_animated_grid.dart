...
class CustomSliverAnimatedGrid extends StatefulWidget {
  ...
  /// inserted with [CustomSliverAnimatedGridState.insertItem] and less the total
  /// number of items that have been removed with
  /// [CustomSliverAnimatedGridState.removeItem].
  ///
  /// Implementations of this callback should assume that
  /// [CustomSliverAnimatedGridState.removeItem] removes an item immediately.
 ...
 /// A delegate that controls the layout of the children within the [GridView].
  ...
  static CustomSliverAnimatedGridState of(BuildContext context) {
    ...
    assert(() {
      if (result == null) {
        throw FlutterError(
          'SliverAnimatedGrid.of() called with a context that does not contain a SliverAnimatedList.\n'
...
class CustomSliverAnimatedGridState extends State<CustomSliverAnimatedGrid>
  ...
  /// [CustomSliverAnimatedGrid.itemBuilder] when the item is visible.
  ///
  ...
  /// will no longer be passed to the [CustomSliverAnimatedGrid.itemBuilder]. However
